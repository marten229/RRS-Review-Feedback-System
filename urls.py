...
from .views import RestaurantListView, RestaurantDetailView, create_reservation, bewertung_abgeben, danke, bewertungen_anzeigen
...
urlpatterns = [
    ...
    path('restaurants/<int:pk>/danke/', danke, name='danke'),  # Aktualisierte URL
